...
// Inicializar o gerenciador de cookies quando o documento estiver carregado
document.addEventListener('DOMContentLoaded', () => {
    new CookieConsent();
});